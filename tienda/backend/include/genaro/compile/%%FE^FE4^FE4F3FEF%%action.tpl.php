<?php /* Smarty version 2.6.14, created on 2016-04-06 16:57:00
         compiled from patrones/P1M3FIL-LIS-EDI/action.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P1M3FIL-LIS-EDI/action.tpl', 35, false),array('modifier', 'explode', 'patrones/P1M3FIL-LIS-EDI/action.tpl', 217, false),)), $this); ?>
<?php echo '<?php'; ?>
...
/**
* Clase Manejadora <?php echo ((is_array($_tmp=$this->_tpl_vars['classname'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
...
class <?php echo ((is_array($_tmp=$this->_tpl_vars['classname'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
...
');
		...
		$nombreTablas= array('<?php echo $this->_tpl_vars['tablename']; ?>
');
...
$this->_sections['select']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 echo $this->_tpl_vars['fields'][$this->_sections['select']['index']]; ?>
 as \"lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['select']['index']]; ?>
\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename']; ?>
";
		...
		$str_select_editar = "SELECT <?php unset($this->_sections['select']);
$this->_sections['select']['name'] = 'select';
$this->_sections['select']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['select']['show'] = true;
$this->_sections['select']['max'] = $this->_sections['select']['loop'];
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 echo $this->_tpl_vars['fields'][$this->_sections['select']['index']]; ?>
 as \"edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['select']['index']]; ?>
\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename']; ?>
";		 
...
?>
		$this->addMatching("fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['fil']['index']]; ?>
","<?php echo $this->_tpl_vars['fields'][$this->_sections['fil']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename']; ?>
");
<?php endfor; endif; ?>
...
?>
		$this->addMatching("lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['lis']['index']]; ?>
","<?php echo $this->_tpl_vars['fields'][$this->_sections['lis']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename']; ?>
");
<?php endfor; endif; ?>
...
?>
		$this->addMatching("edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['fields'][$this->_sections['edi']['index']]; ?>
","<?php echo $this->_tpl_vars['tablename']; ?>
");
<?php endfor; endif; ?>
...
$this->_sections['fecha']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_fil', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  $this->assign('calVal_lis', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  $this->assign('calVal_edi', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
...
<?php endif; ?>
    	$this->addFieldType('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]; ?>
',$fecha);
    	$this->addFieldType('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]; ?>
',$fecha);
...
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]; ?>
',$fecha);

<?php endif;  if ($this->_tpl_vars['types'][$this->_sections['fecha']['index']] == 'gvHidraDatetime'): ?>
...
$this->_sections['string']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['string']['last']       = ($this->_sections['string']['iteration'] == $this->_sections['string']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['string']['index']]);  $this->assign('mascara', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['maskVal']);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  if ($this->_tpl_vars['types'][$this->_sections['string']['index']] == 'gvHidraString'):  if ($this->_tpl_vars['lengths'][$this->_sections['string']['index']] == ""):  $this->assign('length', '200');  else:  $this->assign('length', $this->_tpl_vars['lengths'][$this->_sections['string']['index']]);  endif; ?>
...
');
<?php endif; ?>
		$this->addFieldType('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['string']['index']]; ?>
',$string);
		$this->addFieldType('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['string']['index']]; ?>
',$string);
...
<?php endif;  endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['string']['index']]; ?>
',$string);
...
$this->_sections['int']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['int']['last']       = ($this->_sections['int']['iteration'] == $this->_sections['int']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['int']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  if ($this->_tpl_vars['types'][$this->_sections['int']['index']] == 'gvHidraInteger'): ?>
		$int = new gvHidraInteger(false, <?php echo $this->_tpl_vars['lengths'][$this->_sections['int']['index']]; ?>
);
		$this->addFieldType('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['int']['index']]; ?>
',$int);
		$this->addFieldType('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['int']['index']]; ?>
',$int);		
<?php if ($this->_tpl_vars['notnulls'][$this->_sections['int']['index']] == 'true'): ?>
		$int = new gvHidraInteger(true, <?php echo $this->_tpl_vars['lengths'][$this->_sections['int']['index']]; ?>
);
<?php endif;  if ($this->_tpl_vars['reqVal'] == 1): ?>
		$int->setRequired(true);
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['int']['index']]; ?>
',$int);
...
$this->_sections['float']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['float']['last']       = ($this->_sections['float']['iteration'] == $this->_sections['float']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['float']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  if ($this->_tpl_vars['types'][$this->_sections['float']['index']] == 'gvHidraFloat'):  $this->assign('partes', ((is_array($_tmp=',')) ? $this->_run_mod_handler('explode', true, $_tmp, $this->_tpl_vars['lengths'][$this->_sections['float']['index']]) : explode($_tmp, $this->_tpl_vars['lengths'][$this->_sections['float']['index']]))); ?>
		$float = new gvHidraFloat(false, <?php echo $this->_tpl_vars['partes'][0]; ?>
);
		$float->setFloatLength(<?php echo $this->_tpl_vars['partes'][1]; ?>
);
		$this->addFieldType('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['float']['index']]; ?>
',$float);
		$this->addFieldType('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['float']['index']]; ?>
',$float);		
...
<?php endif; ?>
		$this->addFieldType('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['float']['index']]; ?>
',$float);
...
$this->_sections['components']['loop'] = is_array($_loop=$this->_tpl_vars['fields']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$this->_sections['components']['last']       = ($this->_sections['components']['iteration'] == $this->_sections['components']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['components']['index']]);  $this->assign('componente', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['componente']);  if ($this->_tpl_vars['componente'] == 2): ?>
		$check_fil = new gvHidraCheckBox('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
		...
		$check_lis = new gvHidraCheckBox('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
		...
		$check_edi = new gvHidraCheckBox('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
...
<?php endif;  if ($this->_tpl_vars['componente'] == 3): ?>
		$radio_fil = new gvHidraList('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
		...
		$radio_lis = new gvHidraList('lis_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
		...
		$radio_edi = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
...
<?php endif;  if ($this->_tpl_vars['componente'] == 4): ?>
		$lista_fil = new gvHidraList('fil_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
		...
		$lista_lis = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
