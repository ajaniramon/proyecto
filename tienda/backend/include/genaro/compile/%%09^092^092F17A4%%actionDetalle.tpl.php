<?php /* Smarty version 2.6.14, created on 2016-04-06 16:27:28
         compiled from patrones/P2M2FIL-LISM1LIS/actionDetalle.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P2M2FIL-LISM1LIS/actionDetalle.tpl', 35, false),array('modifier', 'explode', 'patrones/P2M2FIL-LISM1LIS/actionDetalle.tpl', 161, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['select']['last']       = ($this->_sections['select']['iteration'] == $this->_sections['select']['total']);
 ...
 as \"lis_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['select']['index']]; ?>
\"<?php if ($this->_sections['select']['last']):  else: ?>, <?php endif;  endfor; endif; ?> FROM <?php echo $this->_tpl_vars['tablename_detalle']; ?>
";
...
?>
		$this->addMatching("lis_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['lis']['index']]; ?>
", "<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['lis']['index']]; ?>
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields_detalle'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_lis', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types_detalle'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
		$fecha = new gvHidraDate(false);
<?php if ($this->_tpl_vars['calVal_lis'] == 1): ?>
...
<?php endif;  if ($this->_tpl_vars['componente'] == 4): ?>
		$lista_lis = new gvHidraList('lis_<?php echo $this->_tpl_vars['fields_detalle'][$this->_sections['components']['index']]; ?>
');
...
}//End <?php echo ((is_array($_tmp=$this->_tpl_vars['classname_detalle'])) ? $this->_run_mod_handler('capitalize', true, $_tmp) : smarty_modifier_capitalize($_tmp)); ?>
