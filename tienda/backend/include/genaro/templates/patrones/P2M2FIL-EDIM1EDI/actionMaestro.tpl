...
<</section>>
		...
		$this->addSlave('<<$classname_detalle|capitalize>>', array(<<section name=pk_maestro loop=$primaryKeyMaestroArray>>'edi_<<$primaryKeyMaestroArray[pk_maestro]>>',<</section>>), array(<<section name=fk_detalle loop=$foreignKeyDetalleArray>>'edi_<<$foreignKeyDetalleArray[fk_detalle]>>',<</section>>));
