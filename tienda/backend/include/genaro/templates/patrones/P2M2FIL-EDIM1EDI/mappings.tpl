			...
			$this->_AddForward('<<$classname_maestro|capitalize>>__nuevo', 'gvHidraSuccess', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname_maestro|capitalize>>.php&panel=editar');
			...
			$this->_AddForward('<<$classname_maestro|capitalize>>__cancelarTodo', 'gvHidraSuccess', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname_maestro|capitalize>>.php');
