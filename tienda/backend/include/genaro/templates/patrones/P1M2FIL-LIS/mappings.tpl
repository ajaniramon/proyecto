			...
			$this->_AddMapping('<<$classname|capitalize>>__operarBD', '<<$classname|capitalize>>');
			$this->_AddForward('<<$classname|capitalize>>__operarBD', 'gvHidraSuccess', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname|capitalize>>.php&panel=listar');
			$this->_AddForward('<<$classname|capitalize>>__operarBD', 'gvHidraError', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname|capitalize>>.php');
			...
			$this->_AddForward('<<$classname|capitalize>>__nuevo', 'gvHidraSuccess', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname|capitalize>>.php&panel=listar');				
			
			$this->_AddMapping('<<$classname|capitalize>>__insertar', '<<$classname|capitalize>>');
			$this->_AddForward('<<$classname|capitalize>>__insertar', 'gvHidraSuccess', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname|capitalize>>.php&panel=buscar');
			...
			$this->_AddForward('<<$classname|capitalize>>__modificar', 'gvHidraError', 'index.php?view=views/<<$nombreModulo|capitalize>>/p_<<$classname|capitalize>>.php');
