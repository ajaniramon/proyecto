<?php /* Smarty version 2.6.14, created on 2016-04-06 17:10:16
         compiled from Pedidos/p_PedidoMaestro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'CWVentana', 'Pedidos/p_PedidoMaestro.tpl', 1, false),array('block', 'CWBarra', 'Pedidos/p_PedidoMaestro.tpl', 2, false),array('block', 'CWMarcoPanel', 'Pedidos/p_PedidoMaestro.tpl', 5, false),array('block', 'CWPanel', 'Pedidos/p_PedidoMaestro.tpl', 9, false),array('block', 'CWBarraSupPanel', 'Pedidos/p_PedidoMaestro.tpl', 10, false),array('block', 'CWContenedor', 'Pedidos/p_PedidoMaestro.tpl', 14, false),array('block', 'CWFicha', 'Pedidos/p_PedidoMaestro.tpl', 15, false),array('block', 'CWBarraInfPanel', 'Pedidos/p_PedidoMaestro.tpl', 33, false),array('block', 'CWTabla', 'Pedidos/p_PedidoMaestro.tpl', 44, false),array('block', 'CWFila', 'Pedidos/p_PedidoMaestro.tpl', 45, false),array('block', 'CWContenedorPestanyas', 'Pedidos/p_PedidoMaestro.tpl', 61, false),array('function', 'CWMenuLayer', 'Pedidos/p_PedidoMaestro.tpl', 3, false),array('function', 'CWBotonTooltip', 'Pedidos/p_PedidoMaestro.tpl', 11, false),array('function', 'CWCampoTexto', 'Pedidos/p_PedidoMaestro.tpl', 18, false),array('function', 'CWBoton', 'Pedidos/p_PedidoMaestro.tpl', 34, false),array('function', 'CWPaginador', 'Pedidos/p_PedidoMaestro.tpl', 51, false),array('function', 'CWPestanya', 'Pedidos/p_PedidoMaestro.tpl', 62, false),)), $this); ?>
		...
		<?php $this->_tag_stack[] = array('CWContenedor', array()); $_block_repeat=true;smarty_block_CWContenedor($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $this->_tag_stack[] = array('CWFicha', array()); $_block_repeat=true;smarty_block_CWFicha($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<table class="text" cellspacing="4" cellpadding="4" border="0">
					<tr>
					 	<td><?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Idpedido','nombre' => 'fil_idpedido','size' => '4','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['idpedido'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['idpedido']), $this);?>
</td>
					</tr>
					<tr>
					...
					<tr>
					 	<td><?php echo smarty_function_CWCampoTexto(array('textoAsociado' => 'Total','nombre' => 'fil_total','size' => '7','editable' => 'true','visible' => 'true','value' => $this->_tpl_vars['defaultData_PedidoMaestro']['fil_total'],'dataType' => $this->_tpl_vars['dataType_PedidoMaestro']['fil_total']), $this);?>
</td>
					</tr>
					<tr>
