...
//Se utiliza en el CWImagen para poder visualizar cualquier imagen
	...
	//Si la extensión se contempla en nuestro vector de tipos...
	if (array_key_exists($ext, $mime_types))
	{
		$tipo = $mime_types[$ext];
	}
	elseif (function_exists('finfo_open')) //Si no está y existe finfo_open
	{
	...
	print_r($tipo);
	ob_clean();
	if(strpos($tipo,'image')!==false)//Sólo servimos imágenes...
	{
