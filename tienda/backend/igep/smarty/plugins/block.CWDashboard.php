...
function smarty_block_CWDashboard($params, $content, &$smarty)
{
	
	if(!isset($content)) // Si se abre la etiqueta {CWDashboard}...
	{
	...
	else//Se cierra la etiqueta 
	{
		...
		$ini_pantalla .="<div id='wrapper'>";
	
		
		$ini_pantalla .="<nav class='navbar navbar-inverse navbar-fixed-top' role='navigation'>";
		
		$ini_pantalla .="<div class='navbar-header'>";
		$ini_pantalla .="<button type='button' class='navbar-toggle' data-toggle='collapse' data-target='.navbar-ex1-collapse'>";
		$ini_pantalla .="<span class='sr-only'>Toggle navigation</span>";
		$ini_pantalla .="<span class='icon-bar'></span>";
		$ini_pantalla .="<span class='icon-bar'></span>";
		$ini_pantalla .="<span class='icon-bar'></span>";
		$ini_pantalla .="</button>";
		$ini_pantalla .="</div>";
		...
		$ini_pantalla .="<div class='row '>";
		$ini_pantalla .= "<div class='col-xs-7 col-sm-8 col-md-10' >\n";
		$ini_pantalla .="<div class='navbar-header '>";
		$ini_pantalla .="<div id='logoBarDashboard'><img title='GVA' alt='GVA' class='logoBarDashboard' src='custom/blueStyle/images/logos/logoMenu.gif'></div>";
		$ini_pantalla .="<a class='navbar-brand'><b>$codApl</b></a>";
		$ini_pantalla .="</div>";
		$ini_pantalla .="</div>";

	
		$ini_pantalla .= "<div class='col-xs-4 col-sm-2 col-md-2 text-right panel-info option-bar-icon-dash' >\n";
		$ini_pantalla .= "<script type='text/javascript'>$(document).ready(function(){ $('[data-toggle=\"popover\"]').popover({ html : true });}); </script>";
		
		$ini_pantalla .= "<form id='cerrar' class='' name='cerrar' target='oculto' method='get' action='phrame.php'>\n";
		$ini_pantalla .= "<button type='button' class='btnToolTip' data-toggle='popover' data-placement='bottom' title=' <p class=\"text-center title-info \"><b>".$codApl."</b></p>' data-content='<table class=\"table table-striped\"><tr><td><b>Usuario</b></td><td> ".$usuario."</td></td></tr> <tr><td><b>Nombre Aplicación</b></td><td> ".$nomApl."</td></tr>   <tr><td><b>Versión</b></td><td> ".$versionApl."</td></tr></table>'><span class='glyphicon glyphicon-info-sign' aria-hidden='true'></span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		...
		$ini_pantalla .= "<span class='glyphicon glyphicon-log-out info-icon' aria-hidden='true'></span> ";
		$ini_pantalla .= "</button>";	
		$ini_pantalla .= "</form>\n";
		$ini_pantalla .= "</div>\n";
		...
		$ini_pantalla .="<div class='collapse navbar-collapse navbar-ex1-collapse'>";
		$ini_pantalla .="<ul class='nav navbar-nav side-nav'>";
		$ini_pantalla .="<li>";
		
		$ini_pantalla .="<a href='#' data-toggle='collapse' data-target='#menu1'> Módulos principales</a>";
		$ini_pantalla .="<ul id='menu1' class='collapse'>";
		$ini_pantalla .="<li>";
		$ini_pantalla .="$ini_menuModulos";
		$ini_pantalla .="</li>";
		$ini_pantalla .="</ul>";
			
		$ini_pantalla .="<a href='#' data-toggle='collapse' data-target='#menu2'> Herramientas auxiliares</a>";
		$ini_pantalla .="<ul id='menu2' class='collapse'>";
		$ini_pantalla .="<li>";
		$ini_pantalla .="$ini_menuHerramientas";
		$ini_pantalla .="</li>";
		$ini_pantalla .="</ul>";
		
		$ini_pantalla .="<a href='#' data-toggle='collapse' data-target='#menu3'>Administración sistema </a>";
		$ini_pantalla .="<ul id='menu3' class='collapse'>";
		$ini_pantalla .="<li>";
		...
		$ini_pantalla .="</nav>";
		$ini_pantalla .="<div class='block-dashboard'>"; //ini block dashboard
		$fin_pantalla .="</div>"; // fin block dashboard

		$fin_pantalla .= "</div>"; //fin container
		return $ini_pantalla.$content.$fin_pantalla;
	}//Fin else
