 ...
 *
 *
 * @version $Id: gvHidraSelectionWindow_Source.php,v 1.2 2010-11-17 16:36:07 afelixf Exp $
 * 
 * @author Toni: <felix_ant@gva.es>
 *
 * @package gvHIDRA
 */ 
interface gvHidraSelectionWindow_Source {
	...
	* @param integer   
	*/	
	public function search($value,$dependence,$dependenceType);
}
